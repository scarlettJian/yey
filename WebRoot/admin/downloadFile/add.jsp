...
<%
	...
	if (username == null) {
		...
		String td = "";
		String nr = "";
		if (method.equals("upcs")) {
			id = request.getParameter("id");
			List jlist = cb.get1Com("select * from cs where id='" + id + "'", 4);
			xz = jlist.get(1).toString();
			td = jlist.get(2).toString();
			...
			<form action="<%=basePath%>ComServlet" method="post" name="form1">
				<table class="table table-bordered">
					<tr>
						...
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">文件标题：</td>
						<td><input type="text" name="xz" class="span6"
							value="<%=xz%>" required /></td>
					</tr>
					<tr>
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">发布用户：</td>
						<td><input type="text" name="td" class="span6"
							value="<%=td%>" required /></td>
					</tr>
					<tr>
