...
<%
	...
	if (username == null) {
		...
		String nr = cb.getString("select content from Direction where id="+1);
		htmlData = nr;
%>
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>研究方向管理</strong>
		</div>
		<div style="width: 900px; margin: auto;">
			<form action="<%=basePath%>ComServlet" method="post" name="form1">
				<table class="table table-bordered">
					<tr>
						<input type="hidden" name="method" value="direction" />
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">内容：</td>
