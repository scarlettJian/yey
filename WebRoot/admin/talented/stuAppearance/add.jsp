...
<%
	...
	if(username==null){
		...
		String id="";String title="";String nr=""; 
		if(method.equals("upAppear")) {
			id = request.getParameter("id");
			List jlist = cb.get1Com("select * from stuAppearance where id='" + id + "'", 4);
...
<div class="title_right"><strong>学生风采管理</strong></div>  
			...
			<form action="<%=basePath %>ComServlet" method="post" name="form1">
				<table class="table table-bordered">
					<tr>
						...
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">标题：</td>
						<td><input type="text" name="title" class="span6"
