...
<%
	...
	if(username==null){
		...
		String id="";String level="";String name="";String nr=""; 
		if(method.equals("upPost")) {
			id = request.getParameter("id");
			List jlist = cb.get1Com("select * from postgraduate where id='" + id + "'", 4);
			level = jlist.get(1).toString();
...
<div class="title_right"><strong>本科生管理</strong></div>  
			...
			<form action="<%=basePath %>ComServlet" method="post" name="form1">
				<table class="table table-bordered">
					<tr>
						...
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">年级：</td>
						<td><input type="text" name="level" class="span6"
							value="<%=level %>" required /></td>
					</tr>
					<tr>
						<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">姓名：</td>
						<td><input type="text" name="name" class="span6"
