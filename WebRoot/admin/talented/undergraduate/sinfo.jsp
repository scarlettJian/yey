				...
				<table class="table table-bordered table-striped table-hover">
					<tbody>
						<tr align="center">
							...
							<td nowrap="nowrap"><strong>年级</strong></td>
						...
						<%
							String word = Common.toChineseAndTrim(request.getParameter("word"));
								...
								int cou = cb.getMessageCount("select count(*) from postgraduate where level like '%" + word + "%'");//得到信息总数			        
								...
								List pagelist1 = cb.getMessage(Integer.parseInt(page1),
										"select * from postgraduate where level like '%" + word + "%' order by id desc", 4);
						...
						<tr align="center">
							...
							<td nowrap="nowrap"><a
								href="<%=basePath%>admin/talented/postgraduate/add.jsp?method=upPost&id=<%=pagelist2.get(0).toString()%>">修改</a>
								<a
								href="<%=basePath%>ComServlet?method=delPost&id=<%=pagelist2.get(0).toString()%>">删除</a>
							</td>
						</tr>
						<%
							}
