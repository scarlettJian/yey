	...
	<div class="rmain">
		...
		<div class="rlist">
			<table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" class="rtable">
				<tbody>
					<tr class="tr1">
						<td class="rldate daslist">实验室动态</td>
					...
					<tr class="tr<%=(i) % 2%>">
						<td class="rltitle dotlist">
							<a  href="<%=basePath%>newsInfo.jsp?id=<%=pagelist2.get(0).toString()%>"><%=pagelist2.get(1).toString()%></a></td>
						...
						<tbody>
							<tr>
								<td align="center">
									...
									<a href="#" onClick="last2()">尾页</a> <!-- 第<input name="busjump"
